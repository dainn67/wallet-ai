...
| --- | ------------------------------- | ----- | -------- | ---- | ---------- | ------ |
| 2 | Install Provider Dependency      | 1     | no       | 0.5d | —          | open   |
| 3 | Create CounterProvider           | 2     | yes      | 1d   | 001        | open   |
| 4 | Integrate MultiProvider & UI    | 3     | no       | 1.5d | 010        | open   |
| 5 | Integration verification        | 3     | no       | 0.5d | all        | open   |
