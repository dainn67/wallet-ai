...
#
# Usage (sourced):
#   source .gemini/scripts/knowledge-extract.sh
#   knowledge_extract <issue_number>
#
# Usage (standalone):
#   bash .gemini/scripts/knowledge-extract.sh extract <issue_number>
#
...
**Root cause:** <!-- Gemini fills this -->
**Fix:** <!-- Gemini fills this -->
**Approaches tried:** <!-- Gemini fills from journal if available -->
...
- Skillbook: <!-- Gemini fills if reusable pattern found -->
- Auto Memory: <!-- Gemini fills if project-level insight applicable -->
LEARNINGS
}
