...
#   bash .gemini/scripts/pm/skillbook-extract.sh init-skillbook
#   bash .gemini/scripts/pm/skillbook-extract.sh count-skillbook-entries
#   bash .gemini/scripts/pm/skillbook-extract.sh next-skillbook-id
#   bash .gemini/scripts/pm/skillbook-extract.sh append-skillbook-entry <pattern> <ctx> <src> <body>
