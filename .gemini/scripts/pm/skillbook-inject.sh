...
#
# Usage:
#   source .gemini/scripts/pm/skillbook-inject.sh
#   inject_relevant_skills ".gemini/epics/ace-learning/010.md"
#
# Or standalone:
#   bash .gemini/scripts/pm/skillbook-inject.sh inject-relevant-skills <task_file>
#   bash .gemini/scripts/pm/skillbook-inject.sh extract-task-keywords <task_file>
