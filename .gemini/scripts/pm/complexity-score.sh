...
#
# Usage:
#   source .gemini/scripts/pm/complexity-score.sh
#   compute_complexity_score ".gemini/epics/ace-learning/010.md"
#   suggest_model 7       # → "opus"
#   get_strategy_hints 8  # → strategy hints
#
# Or run standalone:
#   bash .gemini/scripts/pm/complexity-score.sh compute-complexity-score <task_file>
#   bash .gemini/scripts/pm/complexity-score.sh suggest-model <score>
#   bash .gemini/scripts/pm/complexity-score.sh get-strategy-hints <score>
