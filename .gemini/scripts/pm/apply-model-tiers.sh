...
# Usage: bash .gemini/scripts/pm/apply-model-tiers.sh
#
# Reads .gemini/config/model-tiers.json and writes model: field
# into each command's YAML frontmatter in .gemini/commands/pm/*.md
