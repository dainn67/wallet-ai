...
#
# Usage:
#   source .gemini/scripts/pm/reflection-generate.sh
...
#   bash .gemini/scripts/pm/reflection-generate.sh get-attempt-number <epic> <issue>
#   bash .gemini/scripts/pm/reflection-generate.sh get-reflection-history <epic> <issue>
#   bash .gemini/scripts/pm/reflection-generate.sh generate-reflection <epic> <issue>
