...
# --- Test 5: References .gemini/designs/ directory ---
echo ""
echo "Test 5: Designs directory reference"
designs_ref=$(grep -c 'designs/' "$TARGET" || true)
assert_ok "references .gemini/designs/ directory (got $designs_ref occurrences)" "$([ "$designs_ref" -ge 3 ] && echo true || echo false)"
