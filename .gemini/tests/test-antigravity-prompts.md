...
| `ccpm-context-sync` | Switch IDE, sync context between Gemini CLI / Antigravity |
...
| A2 | "I just switched from Gemini CLI to Antigravity. Sync my context over." | `ccpm-context-sync` | |
