...
Execute Phase A by following the instructions in `.gemini/commands/pm/epic-verify-a.md`, using `$ARGUMENTS` as the epic name.
...
Execute Phase B by following the instructions in `.gemini/commands/pm/epic-verify-b.md`, using `$ARGUMENTS` as the epic name.
