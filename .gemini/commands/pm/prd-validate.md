...
2. **Locate PRD:**
   - If `.gemini/prds/$ARGUMENTS.md` doesn't exist → `❌ PRD not found: .gemini/prds/$ARGUMENTS.md` and stop.
...
- `.gemini/prds/$ARGUMENTS.md` — the PRD to validate
...
Save to `.gemini/prds/.validation-$ARGUMENTS.md`:
...
📋 Validation: $ARGUMENTS — [STATUS]
  ...
  Report: .gemini/prds/.validation-$ARGUMENTS.md
