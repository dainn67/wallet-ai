...
Read `.gemini/context/handoffs/TEMPLATE.md` for the required structure.
...
- Current verify state: `.gemini/context/verify/state.json` (if exists)

### 3. Write Handoff Note

Create `.gemini/context/handoffs/latest.md` with all required sections from the template:
...
```
✅ Handoff note written: .gemini/context/handoffs/latest.md
