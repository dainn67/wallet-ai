...
Check all task files in `.claude/epics/$ARGUMENTS/` (files matching `[0-9]*.md`):
...
REPO=""
epic_github=$(grep '^github:' .claude/epics/.archived/$ARGUMENTS/epic.md 2>/dev/null | head -1 | sed 's/^github: *//')
