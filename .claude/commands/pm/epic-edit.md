...
REPO=""
epic_github=$(grep '^github:' .claude/epics/$ARGUMENTS/epic.md 2>/dev/null | head -1 | sed 's/^github: *//')
...
gh issue edit {issue_number} --repo "$REPO" --body-file .claude/epics/$ARGUMENTS/epic.md
```
