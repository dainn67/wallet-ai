...
Execute Phase A by following the instructions in `.claude/commands/pm/epic-verify-a.md`, using `$EPIC_NAME` as the epic name.
...
Execute Phase B by following the instructions in `.claude/commands/pm/epic-verify-b.md`, using `$EPIC_NAME` as the epic name.
