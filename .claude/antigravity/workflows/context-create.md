...
- `.claude/rules/frontmatter.md` - For getting real current date/time
...
1. **Read context files** for source data:
   - `.claude/context/project-overview.md` — features, capabilities
   - `.claude/context/project-brief.md` — scope, goals, success criteria
   - `.claude/context/tech-context.md` — tech stack, dependencies, setup
   - `.claude/context/project-structure.md` — directory layout
   - `.claude/context/product-context.md` — user personas, use cases
