...
```bash
bash .claude/scripts/pm/lifecycle-helpers.sh write-epic-verify-state "{\"active_epic\": null, \"last_abort\": {\"epic_name\": \"$EPIC_NAME\", \"aborted_at\": \"$ABORT_DT\", \"reason\": \"DEVELOPER_REASON\", \"iteration_at_abort\": CURRENT_ITER}}"
```
