...
Read `.claude/context/handoffs/latest.md`.

If it doesn't exist:
```
❌ No handoff note found at .claude/context/handoffs/latest.md

Write one: /pm:handoff-write
Template:  .claude/context/handoffs/TEMPLATE.md
```

### 2. Display Content

Display the full contents of `.claude/context/handoffs/latest.md`.
