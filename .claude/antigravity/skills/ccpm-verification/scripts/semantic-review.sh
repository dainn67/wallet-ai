...
#
# Displays the semantic review checklist for Claude to follow.
# Reads from .claude/prompts/task-semantic-review.md if available.
# Falls back to built-in checklist if file is missing.
# Advisory only — exits 0 always.

set -uo pipefail

REVIEW_TEMPLATE=".claude/prompts/task-semantic-review.md"
