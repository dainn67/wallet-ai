...
- The script loads the appropriate profile from `.claude/context/verify/profiles/`
...
Update `.claude/context/verify/state.json` with the final verification outcome.
