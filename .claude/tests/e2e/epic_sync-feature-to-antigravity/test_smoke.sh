...
assert_ok "tech-context has Antigravity Sync section" "$(grep -qi 'antigravity.*sync' "$PROJECT_ROOT/.claude/context/tech-context.md" 2>/dev/null && echo true || echo false)"
