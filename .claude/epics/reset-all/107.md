...
## Acceptance Criteria
- [x] **FR-3 / Cascading Delete:** When a money source is deleted, all records with `money_source_id == id` are also deleted from the database.
- [x] **NFR-1 / Atomicity:** The deletion of records and the source are wrapped in a single database transaction.
