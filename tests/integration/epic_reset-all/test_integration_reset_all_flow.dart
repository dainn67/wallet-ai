...
void main() {
  ...
  testWidgets('Integration: Full Reset All Data Flow', (tester) async {
    ...
    await repository.createRecord(
      Record(moneySourceId: sourceId, amount: 100.0, currency: 'VND', description: 'Lunch', type: 'expense', lastUpdated: DateTime.now().millisecondsSinceEpoch),
    );
  ...
  testWidgets('Integration: Delete Source Flow with cascading record removal', (tester) async {
    ...
    await repository.createRecord(
      Record(moneySourceId: sourceId, amount: 200.0, currency: 'VND', description: 'Gas', type: 'expense', lastUpdated: DateTime.now().millisecondsSinceEpoch),
    );
