...
void main() {
  testWidgets('Integration Test: MultiProvider provides CounterProvider to MyHomePage', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const MyApp());

    // Verify that the CounterProvider is in the widget tree.
    final counterProvider = tester.element(find.byType(MyHomePage)).read<CounterProvider>();
